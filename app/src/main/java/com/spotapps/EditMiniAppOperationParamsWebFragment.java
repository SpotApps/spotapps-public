 ...
 * Use the {@link EditMiniAppOperationParamsWebFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EditMiniAppOperationParamsWebFragment extends Fragment implements EditMiniAppOperationParamsFragment {
    ...
    public EditMiniAppOperationParamsWebFragment() {
    ...
    public static EditMiniAppOperationParamsWebFragment newInstance(String miniAppType, String param2) {
        EditMiniAppOperationParamsWebFragment fragment = new EditMiniAppOperationParamsWebFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit_mini_app_operation_params_web, container, false);
        EditText paramEditor = (EditText) view.findViewById(R.id.mini_app_type_web_txt_fragment);
    ...
    public String getValue() {
        EditText paramEditor = (EditText) getView().findViewById(R.id.mini_app_type_web_txt_fragment);
