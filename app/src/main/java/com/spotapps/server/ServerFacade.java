...
public class ServerFacade {
    public static Spot loadSpot() {
//        RestClient rc = new RestClient();
//        return rc.loadCurrentSpot();
        String spotName = "Hotel Bet Dagan";
    ...
    public static List<MiniApp> loadMiniApps(Spot spot) {
        ...
        list.add(0, MiniAppFactory.createUrlMiniApp("web_link.png", "Call Front Desk", "openPhoneApp", "972542202500", spot));
        list.add(1, MiniAppFactory.createUrlMiniApp("web_link.png", "Car Rental Coupons", "openUrl", "www.getTaxi.com", spot));
        list.add(2, MiniAppFactory.createUrlMiniApp("web_link.png", "View Room Service Menu", "openUrl", "www.hotel.com", spot));
